    ...
    "packages/shared/render/plugins/BaseSiteModules/webflow-brand.js"(exports, module) {
      ...
      Webflow.define("brand", module.exports = function($) {
        ...
        function createBadge() {
          var $brand = $('<a class="hidden w-webflow-badge" style="display: none;"></a>').attr("href", "#");
          var $logoArt = $("<img>").attr("src", "/images/favicon.png").attr("alt", "").css({
            marginRight: "4px",
            width: "0px"
          });
          var $logoText = $("<img>").attr("src", "/images/favicon.png").attr("alt", "");
